            ...
            <div class="col-lg-4 col-md-4">
                <div class="header__logo">
                    <a href="<?= $this->router->generate('index') ?>"><img src="<?= PATH ?>/Public/img/logo_OD.png" alt="" width="60px">
                        <?php if(!$this->twig->isMobile()):?><span class="text-dark">Occasion-</span>Dentaire<span class="text-dark">.com</span><?php endif; ?>
                    </a>
                </div>
            </div>
                ...
                <div class="header__nav">
                    <nav class="header__menu mobile-menu">
                        <ul>
                            ...
                            <li class="<?= $this->twig->isNavActive(['adverts']) ?>"><a href="<?= $this->router->generate('advert_index') ?>"><?= $this->twig->translation('advert.index') ?></a>
                                <ul class="dropdown">
                    ...
                    <div class="header__menu__right">
                        <a href="<?= $this->router->generate('user_profil') ?>" class="login-btn"><i class="fa fa-user mt-2 red"></i></a>
                    </div>
                </div>
            </div>
        </div>
