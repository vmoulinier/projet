...
class Router {
    ...
    public function routing()
    {
        ...
        $this->router->map('GET|POST', '/'.PROJECT_NAME.'/contact', 'home/contact', 'home_contact');
        $this->router->map('GET', '/'.PROJECT_NAME.'/about', 'home/about', 'home_about');
        $this->router->map('GET', '/'.PROJECT_NAME.'/terms', 'home/terms', 'home_terms');

        //user
        $this->router->map('GET|POST', '/'.PROJECT_NAME.'/register', 'user/register', 'user_register');
        ...
        $this->router->map('GET|POST', '/'.PROJECT_NAME.'/user_adverts', 'user/adverts', 'user_adverts');
        $this->router->map('GET', '/'.PROJECT_NAME.'/bookmarks', 'user/bookmarks', 'user_bookmarks');
        $this->router->map('GET|POST', '/'.PROJECT_NAME.'/user_transactions', 'user/transactions', 'user_transactions');
        $this->router->map('GET', '/'.PROJECT_NAME.'/invoice/[i:id]', 'user/invoice', 'user_invoice');
        $this->router->map('GET|POST', '/'.PROJECT_NAME.'/edit_profil', 'user/edit', 'edit_profil');
        ...
        $this->router->map('GET|POST', '/'.PROJECT_NAME.'/admin/adverts', 'admin/adverts', 'admin_adverts');
        ...
        //advert
        $this->router->map('GET|POST', '/'.PROJECT_NAME.'/adverts', 'advert/index', 'advert_index');
        $this->router->map('GET|POST', '/'.PROJECT_NAME.'/advert/[i:id]', 'advert/viewadvert', 'advert_view');
        $this->router->map('GET|POST', '/'.PROJECT_NAME.'/create_advert', 'advert/create', 'create_advert');
        $this->router->map('GET|POST', '/'.PROJECT_NAME.'/edit_advert/[i:id]/[a:admin]?', 'advert/edit', 'edit_advert');
        $this->router->map('POST', '/'.PROJECT_NAME.'/add_bookmark', 'advert/addbookmark', 'add_bookmark_post');

        //request
        $this->router->map('GET|POST', '/'.PROJECT_NAME.'/requests', 'request/index', 'request_index');
        $this->router->map('GET|POST', '/'.PROJECT_NAME.'/request/[i:id]', 'request/viewrequest', 'request_view');
        $this->router->map('GET|POST', '/'.PROJECT_NAME.'/create_request', 'request/create', 'create_request');
        $this->router->map('GET|POST', '/'.PROJECT_NAME.'/edit_request/[i:id]', 'request/edit', 'edit_request');
